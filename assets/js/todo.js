...
function addTodoToDOM(todo,iscompleted,imgName) {
  ...
  crosslabel.style="float:right;padding-top:25px;margin-right:5px;"
  const checkbox = document.createElement("input");
  const image=document.createElement("img");
  image.src = imgName;
  image.style="width:2.5rem;height:2.5rem;margin:5px 1rem 0 1rem;border-radius:50%;border:1px solid black;";
  checkbox.type = "checkbox";
  checkbox.value="false";
  checkbox.style="float:right;margin:26px 5px 0 0;"
  if (iscompleted===true) {
